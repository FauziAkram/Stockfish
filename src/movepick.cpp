...
void MovePicker::score() {
    ...
    for (auto& m : *this)
        ...
        else if constexpr (Type == QUIETS)
        {
            ...
            m.value += threatenedPieces & from ? (pt == QUEEN && !(to & threatenedByRook)   ? 51400
                                                  : pt == ROOK && !(to & threatenedByMinor) ? 26900
            ...
            m.value -= (pt == QUEEN  ? bool(to & threatenedByRook) * 52300
                        : pt == ROOK ? bool(to & threatenedByMinor) * 24400
...
top:
    ...
    case GOOD_QUIET :
        ...
        {
            if ((cur - 1)->value > -7800 || (cur - 1)->value <= quiet_threshold(depth))
                return *(cur - 1);
