...
namespace {
  ...
  constexpr Score DoubledEarly  = S(18,  7);
  constexpr Score Isolated      = S( 1, 20);
  constexpr Score WeakLever     = S( 2, 54);
  constexpr Score WeakUnopposed = S(15, 17);

  // Bonus for blocked pawns at 5th or 6th rank
  constexpr Score BlockedPawn[2] = { S(-19, -8), S(-7, 3) };

  constexpr Score BlockedStorm[RANK_NB] = {
    S(0, 0), S(0, 0), S(66, 73), S(-1, 14), S(-14, 26), S(-7, 4), S(-15, 5)
  };

  // Connected pawn bonus
  constexpr int Connected[RANK_NB] = { 0, 3, 6, 7, 17, 53, 88 };
...
{ V(-27), V(-19), V(-106), V(-10), V(-2), V(-13), V(-24) }
  ...
  constexpr Score KingOnFile[2][2] = {{ S(-19,12), S(-7,-2)  },
                                     {  S(  1, 0), S( 5,-3) }};
