...
moves_loop:  // When in check, search starts here
    ...
    {
        update_all_stats(pos, ss, *this, bestMove, bestMovedPiece, prevSq, quietsSearched, capturesSearched, depth,
