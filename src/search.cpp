...
moves_loop:  // When in check, search starts here
    ...
    MovePicker mp(pos, ttData.move, (ss - 2)->bestMove, depth, &mainHistory, &lowPlyHistory, &captureHistory, contHist,
                  &pawnHistory, ss->ply);
...
Value Search::Worker::qsearch(Position& pos, Stack* ss, Value alpha, Value beta) {
    ...
    MovePicker mp(pos, ttData.move, (ss - 2)->bestMove, DEPTH_QS, &mainHistory, &lowPlyHistory, &captureHistory,
