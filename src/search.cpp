...
int yy1=0, yy2=0, yy3=0, yy4=0;
int ww1=0, ww2=0, ww3=0, ww4=0;
int vv1=0, vv2=0, vv3=0, vv4=0;
TUNE(SetRange(-5000, 5000), xx1, xx2, xx3, xx4);
TUNE(SetRange(-5000, 5000), yy1, yy2, yy3, yy4);
TUNE(SetRange(-5000, 5000), zz1, zz2, zz3, zz4);
TUNE(SetRange(-5000, 5000), ww1, ww2, ww3, ww4);
TUNE(SetRange(-5000, 5000), vv1, vv2, vv3, vv4);
...
+ xx4 * (thisThread->pawnCorrectionHistory[us][pawn_structure_index<Correction>(pos)] > 500)
...
+ zz4 * (thisThread->majorPieceCorrectionHistory[us][major_piece_index(pos)] > 500)
...
+ yy4 * (thisThread->minorPieceCorrectionHistory[us][minor_piece_index(pos)] > 500)
...
+ ww4 * (thisThread->nonPawnCorrectionHistory[WHITE][us][non_pawn_index<WHITE>(pos)] > 500)
...
+ vv4 * (thisThread->nonPawnCorrectionHistory[BLACK][us][non_pawn_index<BLACK>(pos)] > 500);
