...
moves_loop: // When in check, search starts here
    ...
    */
    ...
    {
        int bonus = (depth > xx1) + (PvNode || cutNode) + (bestValue < alpha - xx2 * depth) + ((ss-1)->moveCount > xx3);
        bonus = bonus > xx4 ? bonus + xx5 : bonus;
