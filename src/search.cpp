...
void update_all_stats(const Position& pos,
    ...
    {
        int bestMoveBonus = bestValue > beta + 168 ? quietMoveBonus * xx1 / 100      // larger bonus
        ...
        int moveMalus = bestValue > beta + 165 ? quietMoveMalus * xx2 / 100      // larger malus
