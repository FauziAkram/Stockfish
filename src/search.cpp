...
void update_quiet_histories(
  ...
  dbg_mean_of(ss->ply, 0);
dbg_extremes_of(ss->ply, 0);
  dbg_mean_of(LOW_PLY_HISTORY_SIZE, 1);
dbg_extremes_of(LOW_PLY_HISTORY_SIZE, 1);
  dbg_hit_on(ss->ply < LOW_PLY_HISTORY_SIZE);
