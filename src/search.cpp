...
namespace Stockfish {
int xx1=12, xx2=14362, xx3=12393, xx4=2, xx5=2, xx6=6, xx7=3, xx8=2;
TUNE(SetRange(0, 30), xx1);
TUNE(xx2,xx3);
TUNE(SetRange(1, 20), xx4,xx5,xx6,xx7,xx8);
          ...
          if (value > alpha)
          {
              ...
              else
              {
                  ...
                  if (   depth > 2
                      ...
                      && beta  <  xx2
                      && value > -xx3)
                      depth -= (ss-1)->moveCount < xx4 && ss->moveCount < xx5 && depth < xx6 ? xx7 : xx8;
