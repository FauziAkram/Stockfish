...
namespace Stockfish {
int xx31=3, xx38=3, xx39=1, xx40=1, xx42=175, xx43=1, xx53=213, xx54=6, xx55=5, xx57=5, xx58=7, xx59=1, xx72=2, xx73=0, xx83=6, xx85=3, xx95=200,
xx96=300, xx97=47, xx102=200, xx103=300, xx104=54, zz2=1, xx105=3, xx106=2, zz3=8, zz4=2, xx121=2, xx122=50, xx129=42, xx130=2, xx131=9, xx132=1,
xx133=1, xx135=9, xx136=1, xx140=3564, xx141=4969, xx142=2, xx143=8, zz1=2, xx144=16, xx166=6, xx168=2, zz5=174, zz6=8, zz7=90, zz8=2;
...
moves_loop:  // When in check, search starts here
    ...
    while ((move = mp.next_move()) != Move::none())
    {
        ...
        if (!rootNode && move == ttData.move && !excludedMove
            && depth >= xx83 - (thisThread->completedDepth > 27) + ss->ttPv && is_valid(ttData.value)
        ...
        if (ttCapture)
            r += 1210 + (depth < zz3) * 963;

        // Increase reduction if next ply has a lot of fail high
        if ((ss + 1)->cutoffCnt > zz4)
            r += 1036 + allNode * 848;
        ...
        if (value + inc > bestValue)
        {
            ...
            if (value + inc > alpha)
            {
                ...
                else
                {
                    ...
                    if (depth > std::max(1, zz1) && depth < xx144 && !is_decisive(value))
                        depth -= zz1;
    ...
    else if (!priorCapture && prevSq != SQ_NONE)
    {
        ...
        bonusScale += zz5 * ((ss - 1)->moveCount > zz6);
        bonusScale += zz7 * (ss->cutoffCnt <= zz8);
