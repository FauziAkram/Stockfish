...
moves_loop:  // When in check, search starts here
    ...
    while ((move = mp.next_move()) != Move::none())
    {
        ...
        if (ttCapture && !capture) {
            ...
            r += std::clamp(4 * thisThread->majorPieceCorrectionHistory[us][major_piece_index(pos)],-3092,3192);
            r += std::clamp(3 * thisThread->minorPieceCorrectionHistory[us][minor_piece_index(pos)],-2466,2310);
