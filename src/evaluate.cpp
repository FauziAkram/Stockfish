...
namespace Trace {
  ...
  static double to_cp(Value v) { return double(v) / 126.0; } // PawnValueMg from SF16
...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    Bitboard dblAttackByPawn = pawn_attacks_bb<Us>(pos.pieces(Us, PAWN), pawn_attacks_bb<Us>(pos.pieces(Us, PAWN)));
  ...
  Score Evaluation<T>::king() const {
    ...
    const Bitboard KingFlank[FILE_NB] = {
      ...
      QueenSide | KingSide, QueenSide | KingSide,
  ...
  Score Evaluation<T>::threats() const {
    ...
    b = attacks_bb<PAWN>(b, Us) & nonPawnEnemies;
  ...
  Score Evaluation<T>::passed() const {
    ...
    while (b)
    {
        ...
        const Bitboard forward_file_bb(Color c, Square s); // Fwd decl.
        ...
        if (r > RANK_3)
        {
            ...
            {
                const Bitboard forward_file_bb(Color c, Square s);
                const Bitboard passed_pawn_span(Color c, Square s);
                
                squaresToQueen = forward_file_bb(Us, s);
                unsafeSquares = passed_pawn_span(Us, s);

                bb = forward_ranks_bb(Them, s) & pos.pieces(ROOK, QUEEN);
