...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1757);
  ...
  {
      int nnueComplexity;
      int scale = 1073 + 95 * pos.non_pawn_material() / 5120;
      ...
      nnueComplexity = (  417 * nnueComplexity
                        + 425 * abs(psq - nnue)
