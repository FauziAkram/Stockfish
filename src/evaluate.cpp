...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    const auto adjustEval = [&](int optDiv, int nnueDiv, int npmDiv,
        ...
        v       = (nnue * (npm + 940 + pawnCountMul * pos.count<PAWN>())
    ...
    if (!smallNet)
        adjustEval(524, 32395, 66, 11, 139, 1058, 178, 204);
    else if (psqtOnly)
        adjustEval(517, 32857, 65, 7, 155, 1006, 224, 238);
    else
        adjustEval(515, 32793, 63, 9, 140, 1067, 206, 206);
