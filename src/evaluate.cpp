...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1776);
  ...
  {
      int nnueComplexity;
      int scale = 1005 + 5 * pos.count<PAWN>() + 61 * pos.non_pawn_material() / 4096;
