...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1796);
  ...
  {
      int nnueComplexity;
      int scale = 1082 + 97 * pos.non_pawn_material() / 5120;
      ...
      v = (nnue * scale + optimism * (scale - 750)) / 1024;
  }

  // Damp down the evaluation linearly when shuffling
  v = v * (202 - pos.rule50_count()) / 214;
