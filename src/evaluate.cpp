...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || ((pos.count<ALL_PIECES>() > 7 || pos.count<PAWN>() > 2) && abs(psq) > 1808);
  ...
  {
      int nnueComplexity;
      int scale = 1068 + 92 * pos.non_pawn_material() / 5120;
