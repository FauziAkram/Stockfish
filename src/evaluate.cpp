...
Value Eval::evaluate(const Eval::NNUE::Networks& networks, const Position& pos, int optimism) {
    ...
    const auto adjustEval = [&](int optDiv, int nnueDiv, int pawnCountMul,
    ...
    if (!smallNet)
        adjustEval(513, 32395, 11, 145, 1036, 178, 204);
    else if (psqtOnly)
        adjustEval(517, 32857, 7, 155, 1019, 224, 238);
    else
        adjustEval(499, 32793, 9, 147, 1067, 208, 211);
