...
namespace {
  ...
  int faz1=1760; TUNE(SetRange(1400,2000),faz1);
  int faz2=1076; TUNE(SetRange(940,1140),faz2);
  int faz3=96; TUNE(SetRange(30, 180), faz3);
  int faz4=412, faz5=428; TUNE(SetRange(150, 650), faz4, faz5);
  int faz6=278; TUNE(SetRange(160, 400), faz6);
  int faz7=755; TUNE(SetRange(610, 890), faz7);
  int faz8=214, faz9=214; TUNE(SetRange(130, 280), faz8, faz9);
