...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    int material = (smallNet ? 502 : 557) * pos.count<PAWN>() + (smallNet ? 718 : 659) * pos.count<KNIGHT>() + (smallNet ? 798 : 827) * pos.count<BISHOP>()
                 + (smallNet ? 1272 : 1309) * pos.count<ROOK>() + (smallNet ? 2354 : 2415) * pos.count<QUEEN>();
