...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    const auto adjustEval = [&](int optDiv, int nnueDiv, int pawnCountConstant,
        ...
        v       = (nnue * (npm + pawnCountConstant + 10 * pos.count<PAWN>())
    ...
    if (!smallNet)
        adjustEval(524, 32395, 942, 139, 1058, 178, 204);
    else if (psqtOnly)
        adjustEval(517, 32857, 908, 155, 1006, 224, 238);
    else
        adjustEval(515, 32793, 944, 140, 1067, 206, 206);
