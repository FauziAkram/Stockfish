...
Value Eval::evaluate(const Eval::NNUE::Networks& networks, const Position& pos, int optimism) {
    ...
    const auto adjustEval = [&](int optDiv, int nnueDiv, int npmDiv, int pawnCountConstant,
        ...
        nnue -= nnue * (nnueComplexity * 49 / 30) / nnueDiv;
    ...
    if (!smallNet)
        adjustEval(600, 90980, 65, 1036, 12, 136, 1158, 174, 213);
    else if (psqtOnly)
        adjustEval(533, 32190, 68, 904, 6, 173, 989, 212, 237);
    else
        adjustEval(550, 33208, 63, 996, 9, 149, 1100, 200, 199);
