...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1763);
  ...
  {
      int nnueComplexity;
      int scale = 1074 + 96 * pos.non_pawn_material() / 5120;
      ...
      optimism = optimism * (279 + nnueComplexity) / 256;
      v = (nnue * scale + optimism * (scale - 751)) / 1024;
  }

  // Damp down the evaluation linearly when shuffling
  v = v * (212 - pos.rule50_count()) / 215;
