...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 6 && abs(psq) > 1787);
  ...
  {
      int nnueComplexity;
      int scale = 1005 + 5 * pos.count<PAWN>() + 64 * pos.non_pawn_material() / 4096;
