...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    const auto adjustEval = [&](int optDiv, int nnueDiv, int pawnCountMul,
        ...
        v       = (nnue * (npm + 990 + pawnCountMul * pos.count<PAWN>())
    ...
    if (!smallNet)
        adjustEval(524, 32395, 11, 139, 1058, 178, 204);
    else if (psqtOnly)
        adjustEval(517, 32857, 7, 155, 1006, 224, 238);
    else
        adjustEval(515, 32793, 9, 140, 1067, 206, 206);
