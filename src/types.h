...
constexpr Value PawnValue   = 204;
constexpr Value KnightValue = 818;
constexpr Value BishopValue = 835;
constexpr Value RookValue   = 1340;
constexpr Value QueenValue  = 2660;
