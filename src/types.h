...
constexpr Value PawnValue   = 205;
constexpr Value KnightValue = 822;
constexpr Value BishopValue = 893;
constexpr Value RookValue   = 1431;
constexpr Value QueenValue  = 2725;
