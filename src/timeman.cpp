...
void TimeManagement::init(Search::LimitsType& limits, Color us, int ply) {
    ...
    double minConstant = std::min(0.0054, std::max(0.0044, 0.0035 + 0.0007 * std::log10(limits.time[us] / 1000.0)));
    double optConstant = std::min(0.00334 + 0.0003 * std::log10(limits.time[us] / 1000.0), minConstant);
